...
- **Process notes** showing how the student framed the problem and where AI entered the workflow.
- **AI-use disclosures** identifying prompts, tools, and the student's edits or rejections.
- **Validation memos** explaining how claims, sources, calculations, and assumptions were checked.
- **Oral defenses** in which students answer questions about their recommendation under pressure.
- **Judgment defenses** requiring students to explain why one tradeoff was chosen over another.
- **Version histories or worklogs** that show the path from first framing to final artifact.
