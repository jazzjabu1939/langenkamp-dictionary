...
Koebler's piece names a cognitive load many readers now carry: deciding, sentence by sentence, whether prose is human, AI-generated, AI-smoothed, AI-contaminated, or human writing in a register that AI has learned to imitate. This uncertainty taxes the reader's trust before the argument begins.

## Why it exists

The term exists because the common analogy to the printing press is useful but incomplete. In May 2026, Boris Cherny — creator of Claude Code — compared coding agents to the European printing press: a technology that collapsed the cost of producing and distributing text, eventually expanding literacy and changing who could participate in the written world.[^cherny]
...
This Dictionary supports **bylined human writing assisted by AI and checked by humans**. It rejects the claim that all assistance is fraud, the acceptance of unexamined median output, and the conclusion that uncertainty about authorship makes responsibility irrelevant.
...
- *[Zombie Internet](zombie-internet.md)* — the mixed human/AI substrate through which readers now move.
- *[Earned Parallelism](earned-parallelism.md)* — the diagnostic for one specific AI-register tell.
- *[The Olang' Trap](olang-trap.md)* — the danger that AI-detection reflexes misclassify human writers whose registers resemble the training corpus.
- *[The Lazy Median Hypothesis](lazy-median-hypothesis.md)* — the claim that careful cooperative writing will cluster at the top while lazy machine output dominates the unread middle.
- *[The Sinceerly Stack](sinceerly-stack.md)* — the recursive market for tools that generate AI prose and tools that launder it back toward seeming human.

A few smaller terms also came out of the same morning and remain useful:

- ***The Imperial College Number*** — the April 2026 Imperial College London / Stanford / Internet Archive finding that roughly 35% of new websites in 2026 are AI-generated.
- ***The Fairbanks Tell*** — Eve Fairbanks's diagnostic, quoted by Koebler: *"The tell for AI isn't rhythm, wording, or fact errors. It's that problems with all these elements exist equally & at once."*
- ***The Mamdani Misfire*** — the public accusation that a Zohran Mamdani tweet about swastikas painted on Queens synagogues was AI-generated, when it was almost certainly human. The term names the social cost of lazy AI-detection mode.

## Why it matters in a teaching context

For teachers, AI writing is both a plagiarism problem and a literacy problem.
...
It also changes how faculty read. Forensic detection alone leads to false accusations, resentment, and the Mamdani Misfire at classroom scale. Faculty can instead teach the practices of honest cooperative writing: use the tool, show the work, check the claims, and own the final voice.
...
**Cooperative writing is the practice of working with both the writer's register and the model's while remaining responsible for the seam. The writer reads model output as a stranger's draft, checks it against evidence and purpose, and rejects the model's cadence when it does not match the writer's own.**

**That practice requires *cheng* — alignment of inner state with outer expression — applied to your own prose while a non-self offers you another voice to inhabit. Most people will not do this carefully. Some will. The Dictionary is for the people who will.**
...
The practical standard is to preserve the actual writer's voice, disclose the assistance used, and retain responsibility for the finished work.
...
- *[The Sincere Society](https://freedomtomato.substack.com/p/the-sincere-society)* — Prof. Langenkamp's load-bearing essay on *cheng* as a design principle for institutions and AI systems.
- *[English Major](english-major.md)*

---

[^cherny]: Boris Cherny, *Coding Solved* (talk at Sequoia, May 2026), in audience Q&A. Transcript on file in the Dictionary workspace. Cherny's version of the printing-press analogy is unusually precise about the numbers: roughly 10% literacy in Europe before the press, a 100x collapse in book costs, more literature published in 50 years than in the prior thousand, and a long rise toward broad literacy over subsequent centuries.
