...
kind: glossary
title: "Open Weights"
permalink: /entries/open-weights/
date: 2026-05-23
summary: "Model releases where the trained parameters can be downloaded and run by others. Not the same as open source, but essential to local AI sovereignty because the model can run outside the provider’s API."
draft: false
published: true
---
...
The irony, as of 2026, is that some of the most practically sovereignty-supporting open-weight models have come from Chinese labs — especially *[Qwen](qwen.md)* and *[DeepSeek](deepseek.md)* — while the leading U.S. frontier labs have kept their strongest systems closed. The old map that placed “openness” in the liberal West and “control” in China is no longer good enough.
