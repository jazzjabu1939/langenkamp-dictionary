...
date: 2026-09-01
summary: "A persistent group of AI agents whose shared roles, memory, communication, and governance make the group a meaningful unit of action."
draft: false
published: true
---
...
1. **Distinct members.** The agents have different roles, tools, models, perspectives, or authority.
2. **Shared state.** They can inherit or contribute to some durable memory, workspace, queue, or record.
3. **Communication.** Members can hand off work, challenge one another, or coordinate through an explicit protocol or shared environment.
4. **Continuity.** The arrangement persists beyond a single prompt or one disposable burst of parallel work.
5. **Governance.** Someone or something decides membership, authority, escalation, conflict resolution, and termination.
