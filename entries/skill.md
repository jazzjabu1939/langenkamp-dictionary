...
The risk is not theoretical. In February 2026, Snyk's [ToxicSkills audit](https://snyk.io/blog/toxicskills-malicious-ai-agent-skills-clawhub/) examined **3,984 public agent skills** from ClawHub and skills.sh. It reported that **1,467 skills — 36.82% — contained at least one security issue**, while **534 — 13.4% — contained at least one critical-level issue**, a category covering prompt injection, malicious code, and suspicious downloads. The researchers separately confirmed **76 malicious payloads** involving credential theft, backdoor installation, or data exfiltration. The [technical report](https://arxiv.org/html/2605.28588) is worth reading with the percentages: “security issue” is broader than “malware,” but the confirmed malware means the supply-chain threat is not merely hypothetical.
