...
Gates writes that the same tool that may allow people to learn more than ever could also lead many people to learn less. He cites preliminary evidence associating heavier AI use with lower critical thinking, particularly among younger users.[^gates]
...
- What exactly is being reserved: a whole job, a task, a decision, or a relationship?
- Is the reason dignity, learning, legitimacy, economic transition, or some combination?
- Who has authority to draw and revise the boundary?
- May AI assist inside the reserve, and if so, who remains answerable?
- How are the gains from automation shared with the people carrying the remaining human burden?
