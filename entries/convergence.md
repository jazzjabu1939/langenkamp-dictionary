...
Where [Single-Arrow Fallacy](single-arrow-fallacy.md) is the negative diagnosis — the bias to be unlearned — Convergence is the positive doctrine. It is the shape an honest answer takes when the world is being honest with you about how it works.
...
The corresponding practice — re-pointing the analyst's gaze, on a known cadence, at the same six classes of signal — is treated separately as [Sixfold Skyreading](sixfold-skyreading.md). This entry is the *why*. That entry is the *how*.
...
- [Single-Arrow Fallacy](single-arrow-fallacy.md) — the negative diagnosis this entry is the positive doctrine for
- [Sixfold Skyreading](sixfold-skyreading.md) — the operational practice; six classes of signal on a known cadence
- [Grey Swans](grey-swans.md) — the events the Single-Arrow Fallacy makes invisible until they arrive
- [Oracle Bones](oracle-bones.md) — the older heritage of multi-vector reading; the same discipline in a different vocabulary
- [Opus Addict](opus-addict.md) — the entry where the convergence-of-observers corollary is doing visible work in the footnotes
- [Sovereign Compute](sovereign-compute.md) — the engineering and operator registers converging on the same architectural conclusion

---

[^1]: Andrej Karpathy, *Sequoia Ascent 2026 summary*, 30 April 2026, [karpathy.bearblog.dev/sequoia-ascent-2026/](https://karpathy.bearblog.dev/sequoia-ascent-2026/). The talk is the cleanest engineer-facing statement of the *interpreter-and-context-window* architecture published to date. Read alongside the [Sovereign Compute](sovereign-compute.md) entry, the convergence-of-observers point makes itself.
