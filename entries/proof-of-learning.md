...
The phrase matters because it keeps the focus where it belongs. The goal is to know whether students are learning to think, judge, explain, and stand behind their work in a world where tools are everywhere, not to catch them using tools.
