...
This is where cooperative writing meets *[Cheng](cheng.md)*. Careless AI prose can split a writer's judgment from the confidence expressed on the page. Cooperative writing requires the writer to bring the published claim back into alignment with the judgment the writer can actually defend.
