...
This is why the term belongs near *[AI Writing](ai-writing.md)* but is not identical to it. AI writing names the broad condition after prose-production costs collapse. Cooperative writing names one disciplined response to that condition.
...
The first failure is ventriloquism. The model's cadence takes over, and the human begins to sound like the median internet. This is the danger named in *[The Lazy Median Hypothesis](lazy-median-hypothesis.md)*. The prose may be clean, but it is clean in the way hotel lobbies are clean: functional, anonymous, aggressively unrememberable.
