...
- clear course-level rules for permitted, limited, and prohibited AI use;
- AI literacy that treats prompting, verification, bias, privacy, and disclosure as professional skills;
- assessment designs that make student judgment visible rather than merely reward polished output;
- privacy and data-governance review before tools are required;
- role-based training for faculty, students, and staff;
- human authority for consequential judgments, exceptions, and appeals.
