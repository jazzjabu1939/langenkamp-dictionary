...
date: 2026-05-12
summary: "Marcus Olang's name for the injury of having formal Kenyan English mistaken for machine prose, extended here as a warning about detector bias and the limits of stylistic suspicion."
draft: false
published: true
...
The argument begins with Marcus Olang', not the Dictionary. Olang' published *I'm Kenyan. I Don't Write Like ChatGPT. ChatGPT Writes Like Me.* on 8 July 2025.[^olang] The Dictionary's contribution is to name the recurring failure mode and connect it to the *AI Writing* cluster.
...
A 2023 study tested seven then-current detectors on essays by native and non-native English writers. The detectors frequently classified the latter as AI-generated.[^liang] That is direct evidence of bias in a class of detectors and a particular test set. It is not proof that every current product fails in the same way or at the same rate.
...
*[AI Writing](/entries/ai-writing/)* · *[Originality.ai](/entries/originality-ai/)* · *[Earned Parallelism](/entries/earned-parallelism/)* · *[The Lazy Median Hypothesis](/entries/lazy-median-hypothesis/)* · *[Mediation (a la Gibson)](/entries/mediation-a-la-gibson/)*

---

[^olang]: Marcus Olang', *I'm Kenyan. I Don't Write Like ChatGPT. ChatGPT Writes Like Me.*, Substack, 8 July 2025: <https://marcusolang.substack.com/p/im-kenyan-i-dont-write-like-chatgpt>.

[^liang]: Weixin Liang et al., “GPT detectors are biased against non-native English writers,” *Patterns* 4, no. 7 (2023): <https://pubmed.ncbi.nlm.nih.gov/37521038/>.
