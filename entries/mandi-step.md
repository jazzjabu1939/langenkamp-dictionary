...
date: 2026-05-21
summary: "The small human intervention inside a system that prevents an automated workflow from damaging trust. Named from the McGrew auction-yard story in Step Into the Loop."
draft: false
published: true
---
...
The term comes from Prof. Langenkamp's Substack piece *Step Into the Loop*, where Mandi at McGrew Equipment repaired a relationship bruise created by a CRM/accounts-receivable workflow. The invoice needed to be paid. The process had a reason. But the automated signal did not know the customer relationship. Mandi did.
