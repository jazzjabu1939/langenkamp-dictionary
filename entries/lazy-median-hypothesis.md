...
1. first-pass generated text became reliably equivalent to carefully revised work under sustained reading and factual inspection; or
2. ordinary users began checking and revising generated output often enough that unchecked generation was no longer the default shortcut.
...
- *[Zombie Internet](/entries/zombie-internet/)* — abundant prose without a responsible reader or writer
- *[Earned Parallelism](/entries/earned-parallelism/)* — one editorial check
- *[The Olang' Trap](/entries/olang-trap/)* — the structural bias of the AI-detection reflex
- *[The Sinceerly Stack](/entries/sinceerly-stack/)* — the recursive detection-and-evasion layer
- *[Mediation (a la Gibson)](/entries/mediation-a-la-gibson/)*
- *[English Major](/entries/english-major/)*
- *[The Sincere Society](https://freedomtomato.substack.com/p/the-sincere-society)* — the related argument from *cheng*
