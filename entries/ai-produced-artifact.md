...
- **AI-use appendix.** What tools were used, for what purpose, and where the student rejected or revised output.
- **Prompt-and-response excerpt.** Not every prompt, just the moments that shaped the work.
- **Validation memo.** How the student checked facts, figures, sources, assumptions, and model claims.
- **Judgment defense.** The student answers questions about the recommendation, tradeoffs, and uncertainty.
