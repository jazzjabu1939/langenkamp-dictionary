...
- IBM Technology / YouTube, "Why AI Makes the Humanities More Important Than Ever": <https://www.youtube.com/watch?v=l-QPwk_f4eE>.
...
[^ibm-humanities]: IBM Technology, "Why AI Makes the Humanities More Important Than Ever," YouTube, 26 July 2026. <https://www.youtube.com/watch?v=l-QPwk_f4eE>. The video is useful here because it does not merely repeat the familiar "AI lacks understanding" claim. It names the practical consequence: the human becomes the interpreter of probabilistic output.

*Related entries: [Token angst](token-angst.md), [Naming](naming.md), [Descartes was wrong](descartes-was-wrong.md), [Human judgment layer](human-judgment-layer.md), [Verification gap](verification-gap.md).*
