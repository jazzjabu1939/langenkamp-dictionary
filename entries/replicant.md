...
1. **Role substitution**: the move from help with a task to occupation of a durable human role.
2. **Implanted memory**: the use of memory architecture to stabilize, control, or humanize a constructed being.
3. **Manufactured personhood**: the corporate temptation to build the visible signs of a person without accepting the obligations that follow.
