...
- evaluation routines
- local and cloud model blends
- interfaces that people actually use
...
- How do we avoid rent-a-brain dependence?
- Who owns an agent once it touches real work?
- How do we know the answer is true?
- How do we hand work from one system to another?
- How do we stop tool access from becoming chaos?
- How do we teach people to use the system without pretending it is magic?
