...
- **Skyreading is slower, less marketable, and less confident** than single-arrow prediction. It will lose sales contests. It is intended to win predictions over time.
- **Information asymmetry is real.** Many vectors require access we do not have (boardroom conversations, internal reorgs, classified intelligence). A careful outsider can detect convergence, but should be modest about predictive claims until the framework has a track record.
